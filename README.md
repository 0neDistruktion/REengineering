...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=0neDistruktion_REengineering&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=0neDistruktion_REengineering)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=0neDistruktion_REengineering&metric=coverage)](https://sonarcloud.io/summary/new_code?id=0neDistruktion_REengineering)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=0neDistruktion_REengineering&metric=bugs)](https://sonarcloud.io/summary/new_code?id=0neDistruktion_REengineering)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=0neDistruktion_REengineering&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=0neDistruktion_REengineering)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=0neDistruktion_REengineering&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=0neDistruktion_REengineering)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=0neDistruktion_REengineering&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=0neDistruktion_REengineering)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=0neDistruktion_REengineering&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=0neDistruktion_REengineering)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=0neDistruktion_REengineering&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=0neDistruktion_REengineering)
